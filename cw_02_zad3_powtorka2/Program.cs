...
while (wybor != 4)
{
    ...
    if (wybor == 2)
    {
        ...
        if (istnieje == false)
        {
            ...
            nazwa[index] = podanaNazwa;
            ilosc[index] = podanaIlosc;
            cena[index] = podanaCena;

            index++;

            Console.WriteLine("Dodano: " + nazwa[index] + " " + ilosc[index] + " " + cena[index]);
